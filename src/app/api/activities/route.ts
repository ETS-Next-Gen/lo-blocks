    ...
    const activities = Object.fromEntries(
      Object.entries(idMap)
        ...
        .map(([id, langMap]: [string, any]) => {
          ...
          const availableLocalesMap: Record<string, ContentTier> = {};
          ...
          for (const locale of availableLocales) {
            ...
            availableLocalesMap[locale] = olxJson.autogenerated ? 'bestEffort' : 'supported';
          }

          // Get edit path from provenance
          const bestLocale = getBestLocaleServer(request, availableLocales);
          const bestEntry = langMap[bestLocale];
