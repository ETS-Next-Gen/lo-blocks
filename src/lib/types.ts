...
// - 'curated': Human-reviewed, officially supported
// - 'autogenerated': LLM-generated or auto-translated, best-effort only
// Future: Could add ratings/scores ('excellent', 'good', 'mediocre') with computation step
export type CurationStatus = 'curated' | 'autogenerated';
...
export interface OlxJson {
  ...
  description?: string;
  category?: string;
  lang?: string;  // BCP 47 language tag (e.g., 'en-Latn-US', 'ar-Arab-SA')
  curationStatus: CurationStatus;  // Always present (Zod default: 'curated')
  source_file?: string;  // Source file for auto-translated/generated content
  source_version?: string;  // Source version hash for re-translation detection
