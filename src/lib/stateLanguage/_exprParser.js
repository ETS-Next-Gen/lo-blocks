...
function peg$parse(input, options) {
  ...
  const peg$e18 = peg$literalExpectation("Math", false);
  const peg$e19 = peg$literalExpectation("children", false);
  ...
  const peg$e35 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "_"], false, false, false);
  ...
  function peg$f14(sigil, id, fields) {
    return {
      type: 'SigilRef',
      sigil,
      id,
  ...
  function peg$f15() {    return { type: 'Identifier', name: 'Math' };  }
  function peg$f16() {    return { type: 'Identifier', name: 'children' };  }
