...
export const OLXMetadataSchema = z.object({
  ...
  // Translation provenance and curation status
  autogenerated: z.boolean().optional(),  // true = LLM-generated, unverified; undefined = native/official
  source_file: z.string().optional(),     // If autogenerated, which file it came from (e.g., 'mult.olx')
  source_version: z.string().optional(),  // If autogenerated, source file version for re-translation (e.g., 'a34a12')
